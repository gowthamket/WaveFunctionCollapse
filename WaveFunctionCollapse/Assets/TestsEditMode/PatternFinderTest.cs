...
namespace Tests
{
    public class PatternFinderTest
    {
        ...
        int patternSize = 1;
        IFindNeighboutStrategy strategy = new NeighbourStartegySize1Default();
        [OneTimeSetUp]
        public void Init()
        {
        ...
        public void PatternFinderCheckNeighbours2Test()
        {
            ...
            Assert.That(neighbours.directionNeighbourPatternDictionary.Count == 2);
        }
        ...
        public void PatternFinderCheckNeighbours4Test()
        {
            ...
            Assert.That(neighbours.directionNeighbourPatternDictionary.Count == 4);
        }
        ...
        public void PatternFinderCheckNeighboursPattern0UP()
        {
            ...
            var neighbours = PatternFinder.FindPossibleNeighbursForAllPatterns(strategy, patterndataResults);
            if (patternSize == 1)
                Assert.That(patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(0, 0) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Up).ElementAt(0)].Pattern.GetGridValue(0, 0));
            else
            {
                Assert.That(
                    patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(0, patternSize - 1) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Up).ElementAt(0)].Pattern.GetGridValue(0, 0)
                    && patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(patternSize - 1, patternSize - 1) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Up).ElementAt(0)].Pattern.GetGridValue(patternSize - 1, 0)
                    );
            };
        ...
        public void PatternFinderCheckNeighboursPattern0RIGHT()
        {
            ...
            var neighbours = PatternFinder.FindPossibleNeighbursForAllPatterns(strategy, patterndataResults);
            if (patternSize == 1)
                Assert.That(patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(0, 0) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Right).ElementAt(0)].Pattern.GetGridValue(0, 0));
            else
            {
                Assert.That(
                    patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(patternSize - 1, 0) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Right).ElementAt(0)].Pattern.GetGridValue(0, 0)
                    && patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(patternSize - 1, patternSize - 1) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Right).ElementAt(0)].Pattern.GetGridValue(0, patternSize - 1)
                    );
            };
        ...
        public void PatternFinderCheckNeighboursPattern0LEFT()
        {
            ...
            var neighbours = PatternFinder.FindPossibleNeighbursForAllPatterns(strategy, patterndataResults);
            if (patternSize == 1)
                Assert.That(patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(0, 0) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Left).ElementAt(0)].Pattern.GetGridValue(0, 0));
            else 
            {
                Assert.That(
                    patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(0, patternSize - 1) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Left).ElementAt(0)].Pattern.GetGridValue(patternSize - 1, patternSize - 1)
                    && patterndataResults.PatternIndexDictionary[0].Pattern.GetGridValue(0, 0) == patterndataResults.PatternIndexDictionary[neighbours[0].GetNeighboursInDirection(Direction.Left).ElementAt(0)].Pattern.GetGridValue(1, 0)
                    );
            };
